...
void state_advance()		/* alternate between toggling red & green */
{
  ...
  case 0:
    switch(substate){
    case 0: changed = 1; red_on = 0; green_on = 0; substate = 1; buzzer_set_period(1000); break;
    case 1: changed = toggle_green(); substate = 2; buzzer_set_period(2000); break;
    case 2: changed = toggle_red(); toggle_green(); buzzer_set_period(3000); substate = 3; break;
    case 3: changed = toggle_green(); substate = 0; buzzer_set_period(4000); break;
    }
    led_changed = changed;
    led_update();
    break;
